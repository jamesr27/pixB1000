// James Reeves. Get serial working on uart 4 for the kill switch
// ------------------------------------------------------------------------------
//   Includes
// ------------------------------------------------------------------------------
...
initialize_defaults()
{
	...
	uart_name = (char*)"/dev/ttyS6";	// This is ouptu port 4. I believe.
	baudrate  = 38400;
...
//	{
//		// the parsing
//		msgReceived = mavlink_parse_char(MAVLINK_COMM_1, cp, &message, &mavStatus);
//
//		// check for dropped packets
//		if ( (lastStatus.packet_rx_drop_count != mavStatus.packet_rx_drop_count) && debug )
//		{
//			printf("ERROR: DROPPED %d PACKETS\n", mavStatus.packet_rx_drop_count);
//			unsigned char v=cp;
//			fprintf(stderr,"%02x ", v);
//		}
//		lastStatus = mavStatus;
//	}
//
...
int
Serial_Port::write_bytes(char* &bytes)
{
	unsigned len = sizeof(bytes);

	_write_port(bytes,len);
...
_setup_port(int baud, int data_bits, int stop_bits, bool parity, bool hardware_control)
{
	...
	{
		printf("Crashing out here, before I can set any flags because tcgetattr not working. \n");
	...
	{	
		printf("Crashing after configuration? \n");
